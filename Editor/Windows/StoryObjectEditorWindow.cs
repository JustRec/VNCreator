    ...
    public class StoryObjectEditorWindow : EditorWindow
    {
        ...
        void MouseDown(MouseDownEvent _e)
        {
            if (_e.button == 1)
            {
                ...
                _menu.AddItem(new GUIContent("Add Node"), false, () => graphView.GenerateNode("", mousePosition, 1, false, false, false));
                _menu.AddItem(new GUIContent("Add Node (2 Choices)"), false, () => graphView.GenerateNode("", mousePosition, 2, false, false, false));
                _menu.AddItem(new GUIContent("Add Node (3 Choices)"), false, () => graphView.GenerateNode("", mousePosition, 3, false, false, false));
                _menu.AddItem(new GUIContent("Add Node (Start)"), false, () => graphView.GenerateNode("", mousePosition, 1, true, false, false));
                _menu.AddItem(new GUIContent("Add Node (End)"), false, () => graphView.GenerateNode("", mousePosition, 1, false, true, false));
                _menu.AddItem(new GUIContent("Add Condition"), false, () => graphView.GenerateNode("", mousePosition, 1, false, false, true));
